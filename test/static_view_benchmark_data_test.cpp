...
using StaticViews = boost::mpl::list<
ViewBenchmarkData<pni::core::static_array<pni::core::uint8,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::int8,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::uint16,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::int16,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::uint32,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::int32,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::uint64,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::int64,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::float32,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::float64,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::float128,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::complex32,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::complex64,10,100>>,
ViewBenchmarkData<pni::core::static_array<pni::core::complex128,10,100>>,
ViewBenchmarkData<pni::core::static_array<std::string,10,100>>
>;


BOOST_AUTO_TEST_SUITE(BenchmarkCommonTest)

BOOST_AUTO_TEST_SUITE(StaticViewBenchmarkData)

BOOST_AUTO_TEST_CASE_TEMPLATE(test_construction,T,StaticViews)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_assignment,T,StaticViews)
{
  pni::core::shape_t shape{10,100};
  T bm_data(shape);
