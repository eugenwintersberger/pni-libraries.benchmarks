...
//! 
//! This trait selects the inplace benchmark type depending on whether the 
//! pointer or the array type should be used. This template must be 
//! specialized for pointer and non-pointer benchmarks.
//!
...
//! 
//! Selects the pointer pointer inplace benchmark type in case that 
//! the use_ptr_flag is true.
//!
//! \tparam ATYPE array type
//!
...
//! 
//! Selects the array inplace benchmark type in the case that use_ptr_flag 
//! is false.
//! 
//! \tparam ATYPE array type
//!
...
//! 
//! Select the binary benchmark type depending on the status of the 
//! use_ptr_flag provided as the second template parameters. If the flag is 
//! true the pointer benchmark type will be used. In case of false the array 
//! benchmark is used.  This class has to be specialized for each value 
//! of use_ptr_flag
//! 
//! \tparam ATYPE array type
